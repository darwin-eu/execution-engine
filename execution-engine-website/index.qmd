...
The Darwin Execution Engine is a web application that runs Darwin / OHDSI studies written with R code in pre-configured runtime environments using Docker.
